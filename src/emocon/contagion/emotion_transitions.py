...
def save_results(counts, probs):
    ...
    counts.to_csv("results/emotion_transition_counts.csv")
    probs.to_csv("results/emotion_transition_probs.csv")

    # Also save JSON 
    counts.to_json("results/emotion_transition_counts.json", indent=4)
    probs.to_json("results/emotion_transition_probs.json", indent=4)
...
def plot_heatmap(probs):
    ...
    output_path = "figures/emotion_transition_heatmap.png"
