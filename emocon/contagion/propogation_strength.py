...
def plot_propagation(df_results):
    ...
    out_path = "emocon/figures/emotion_propagation_strength.png"
...
def save_results(df_results):
    ...
    df_results.to_csv("emocon/results/emotion_propagation.csv")
    df_results.to_json("emocon/results/emotion_propagation.json", indent=4)
